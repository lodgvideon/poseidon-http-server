...
* server.PprofHandler() moves to server/pprof.Handler(). Update the import to github.com/lodgvideon/poseidon-http-server/server/pprof and the call to pprof.Handler(); behaviour is unchanged. cmd/poseidon-server, examples/observability-server and docs/usage.md are updated here. Silently exposing runtime internals on every consumer's default mux is not a contract worth preserving.
...
* close two cross-transport security gaps the architecture review surfaced ([#214](https://github.com/lodgvideon/poseidon-http-server/issues/214)) ([76fbbc5](https://github.com/lodgvideon/poseidon-http-server/commit/76fbbc53c076a3585599da8830e12af672c00860)), closes [#209](https://github.com/lodgvideon/poseidon-http-server/issues/209) [#210](https://github.com/lodgvideon/poseidon-http-server/issues/210)
...
* bump poseidon-http-client v0.9.0 → v0.11.0 ([#62](https://github.com/lodgvideon/poseidon-http-server/issues/62)) ([80fbfdb](https://github.com/lodgvideon/poseidon-http-server/commit/80fbfdbddf451546a2eb9733a6030271e844eb7e))
